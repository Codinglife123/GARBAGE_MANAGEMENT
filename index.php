            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body    c1">
                  ...
                  <p class="card-text">ONLY FOR LOCAL USERS </p>
                  <a href="public-login.php" class="btn btn-success">REGISTER/SIGN IN</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body c1">
                  ...
                  <p class="card-text">ONLY FOR MUNICIPALITY OFFICERS </p>
                  <a href=".\muncipalty\officer-login.php" class="btn btn-success">LOGIN</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body c1">
                  ...
                  <p class="card-text">ONLY FOR HEALTHCARE PROVIDER WORKERS </p>
                  <a href="health_care\health_care_login.php" class="btn btn-success">LOGIN</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body c1">
                  ...
                  <p class="card-text">ONLY FOR PRIVATE SECTORS </p>
                  <a href="ppp_page/public_sign_in.php" class="btn btn-success">SIGN IN</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body c1">
                  ...
                  <p class="card-text">ONLY FOR MUNICIPALITY WORKERS </p>
                  <a href="worker_site/worker_sign_in.php" class="btn btn-success">LOGIN</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body c1">
                  ...
                  <p class="card-text">ONLY FOR GOVT. AUTHORISED OFFICIALS </p>
                  <a href="government-site\govt_sigin.php" class="btn btn-success">LOGIN</a>
                </div>
              </div>
            </div>
          </div>
